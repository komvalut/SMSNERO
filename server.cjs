...
<body>
  ...
  <script>
    ...
    var LANGS=[
      ...
      {code:"BS",flag:"&#127463;&#127462;",strings:{subtitle:"Iznajmi telefonski broj i primaj SMS/OTP poruke. Plaćanje putem Bitcoin Lightning.",register:"Registruj se",logout:"Odjava",wallet:"Novčanik",deposit:"Dopuna",ref_label:"Promo kod:",ref_apply:"Primijeni",tab_otp:"Primi OTP",tab_p2p:"P2P Tržnica",tab_send:"Pošalji SMS",avail_nums:"Dostupni brojevi",no_nums:"Nema dostupnih brojeva.",login_req:"Prijavi se ili registruj.",my_nums:"Moji aktivni brojevi",otp_inbox:"OTP Sandučić",list_num:"Oglasi tvoj broj",get_num:"Nabavi broj",cancel:"Odustani",price:"Cijena",select_country:"Odaberi državu",select_service:"Odaberi servis"}},
