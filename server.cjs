...
<body>
  <main>
    ...
    <div class="box">
      ...
      <div id="wallet-bar" style="display:none;margin-top:10px;padding-top:10px;border-top:1px solid #333;align-items:center;gap:10px;flex-wrap:wrap;">
