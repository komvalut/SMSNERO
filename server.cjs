...
<body>
  <main>
    ...
    <div class="box" style="margin-top:12px;padding:14px 16px;">
      ...
      <form onsubmit="adminLogin();return false;" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
        <input id="adminPass" type="password" placeholder="Admin password" style="flex:1;min-width:140px;max-width:220px;">
        <button type="submit" style="padding:8px 18px;font-size:0.9em;">Login</button>
      </form>
    </div>
  </main>
  <script>
